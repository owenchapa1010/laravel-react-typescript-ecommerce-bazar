        ...
        <div className="card-body p-4">
          ...
          <div className="my-4 max-h-[300px] overflow-auto">
            {miniCartItems.length === 0 ? (
              <div className="py-2 text-gray-500 text-center dark:text-gray-400">
              ...
              miniCartItems.map((item) => (
                <div
                  key={item.id}
                  className="flex gap-4 p-3 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-all duration-300"
                >
                  <Link
